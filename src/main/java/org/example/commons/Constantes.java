...
public class Constantes {
    ...
    public static final String MENU1 = "-----------------------------------" +
            "\nSeleccione modo jugador o Administrador:" +
            "\n-----------------------------------" +
            "\n1.MODO JUGADOR" +
            "\n2.MODO ADMINISTRADOR";
    public static final String MENU_ADMIN =
                    "-----------------------------------" +
                    "\nBienvenido al manu de administrador." +
                    "\n-----------------------------------" +
                    "\n1.Consultar si la lista esta vacia." +
                    "\n2.Imprimir lista" +
                    "\n3.Imprimir todos los elementos de la categoria que quieras" +
